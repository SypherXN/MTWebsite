...
summary: "Mixed-reality game for Meta Quest 3 where players chase and catch virtual flies in your real room—in Early Access on Meta Store since July 31, 2026"
overview: "Fly Exterminator is a mixed-reality game for Meta Quest 3 from [Boundary Interactive LLC](https://boundaryinteractive.com), a studio I co-founded. Players chase and catch virtual flies in their real room using Quest scene capture, with quick reflex gameplay, satisfying interactions, and MR mechanics built for standalone VR. The title has been in Early Access on Meta Store since July 31, 2026."
...
- Co-founded Boundary Interactive LLC and led co-development of Fly Exterminator, a mixed-reality title for Meta Quest 3 in Early Access on Meta Store since July 31, 2026 — [boundaryinteractive.com](https://boundaryinteractive.com)
...
- Drove work through structured production phases—prototype, pre-production, production, and post-production—with playtest-driven iteration
- Integrated MetaXR systems for spatial audio, virtual–physical interaction, and immersive feedback
...
In ideation we explored VR ideas focused on fun rather than narrative. Combining my interest in turning everyday experiences into games with my partner's memory of killing flies in summer, we landed on Fly Exterminator and built prototypes for virtual-real object interaction, sound spatialization, and player-object interactions.

Pre-production focused on a vertical slice: main menu, two game modes, and a results screen forming a complete loop. See the [vertical slice demo](https://www.youtube.com/watch?v=y1WiJny65g8).
...
Post-production emphasized polish: UI redesigns plus music, SFX, and VFX, culminating in the teaser shown in the hero video. The game has been in Early Access on Meta Store since July 31, 2026 — see [Boundary Interactive](https://boundaryinteractive.com) for updates.
